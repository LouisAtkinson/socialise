...
function Post({ _id, content, author, recipient, date, likes, comments, update }: PostProps) {  
  ...
  const handleLikeClick = async () => {
    try {
      ...
      const endpoint = isLiked ? `https://socialise-seven.vercel.app/posts/${_id}/unlike` : `https://socialise-seven.vercel.app/posts/${_id}/like`;
  ...
  const handleDeleteClick = async () => {
    try {
      ...
      const response = await fetch(`https://socialise-seven.vercel.app/posts/${_id}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
        }
  ...
  const handleCommentSubmit = async () => {
    if (newComment) {
      try {
        ...
        const response = await fetch(`https://socialise-seven.vercel.app/posts/${_id}/comments`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
