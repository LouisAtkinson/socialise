...
const LikeButton: React.FC<LikeButtonProps> = ({ isLiked, likeFunction }) => {
  return (
    <button className="like-button" onClick={likeFunction} aria-label="Like">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 16 16"
        height="20px"
        width="20px"
        fill={isLiked ? "#FF0000" : "var(--primary-color"} 
        stroke={isLiked ? "none" : "#aaa"} 
        strokeWidth="1" 
      >
